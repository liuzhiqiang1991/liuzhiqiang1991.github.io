    ...
    [
        {
            ...
            "predicates": [{
                "name": "Path",
                "args": { "_genkey_0": "/demo/**", "_genkey_1": "/test/**" }
            }],
            "filters": []
        },
        {
            ...
            "predicates": [{
                "name": "Path",
                "args": { "_genkey_0": "/demo2/**", "_genkey_1": "/test2/**" }
            }],
            "filters": []
        }
    ]
...
#### 6、测试： curl 'http://localhost:8085/demo/hello'
