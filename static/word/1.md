...
```
    ...
    comic漫画
    transmit传播
    They can replace them with new problems such as alcoholism, gambling addition, sexually transmitted diseases.
    ...
    Not only is it Indian cuisine, which Koothrappali loathes, it contains a generous helping of peanuts,
    which will reduce Wolowitz to a wheezing 97-pound blister.

    ingredient原料、成分
    render提供、粉刷
    uninhabitable不宜居住的
    And finally, its main ingredient is paneer, a farmer's cheese that would cause Leonard to render any room
